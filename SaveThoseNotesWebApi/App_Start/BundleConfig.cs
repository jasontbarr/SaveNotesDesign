...
namespace SaveThoseNotesWebApi
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/app").Include(
                      ...
                      "~/App/Scripts/Services/NoteFactory.js",
                      ...
                      "~/App/Scripts/Controllers/RegisterController.js",
                      "~/App/Scripts/Controllers/CarouselController.js"
                      ));
